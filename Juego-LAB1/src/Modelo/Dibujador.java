...
public class Dibujador {
    ...
    public void Dibujar(Laberinto l,Avatar avatar,String mensaje,String movs[]){
        
        System.out.println();
        System.out.println();
        System.out.println("LEYENDA DE COMO MOVERSE");
        System.out.println("--"+movs[2]+"--: IZQUIERDA\n--"+movs[3]+"--: ABAJO\n--"+movs[1]+"--: DERECHA\n--"+movs[4]+"--: ARRIBA");
        System.out.println("--"+movs[5]+"--: INTERACTUAR\n--"+movs[0]+"--: SALIR°");        
        int x=avatar.getX();
        int y=avatar.getY();
    ...
    private  void formatear(String cadena, int cantXLin) {
     ...
     public  String imprimir_historia(int decision){        
                ...
                formatear("Poseidón, el señor que todo lo sabe, había decidido dar un paseo por la tierra de los humanos. Se vistió de lluvia. El cielo entonces tornó su celeste color a gris y se nubló. Cada gota viajaba libre como él. En todo el mundo llovió, y así el señor observó a la humanidad, libre como él. Sin embargo, esta libertad había sido abusada.\n"
                        + "El señor danzó, y las olas del mar danzaron con él. El baile no había hecho más que empezar. Los botes de pesca y barcos de transporte de carga pesada que flotaban los mares del Pacífico se entregaron a él. Luego el señor cantó, y las gotas de agua se convirtieron en chorros que impactaban el mar. La tierra de los humanos al señor también se entregó. \n"
                        + "Desde entonces, la tierra de los humanos ya no era más de ellos. Poseidón vio, sin embargo, que debía crear un nuevo ser. Fue así que el señor que todo lo sabe arrojó al mar huevos de varios colores. Cada huevo representaba una especie nueva.\n"
                        ...
                        + "Objetos a usar (descascarar): huevos", 70);
                System.out.println();
