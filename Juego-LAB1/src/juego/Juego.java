    ...
    private static void iniciarBatalla(Avatar a,Integer newX,Integer newY){
     ...
     private static Integer procesarInstruccion(String cadActual,Avatar avatar) {
        ...
        if (cadActual.compareTo(movs[1]) == 0) {
            ...
            respuesta = laberinto.comprobarTipo(avatar.getX() + 1, avatar.getY());
            if (respuesta != -1) {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            if (decision == 0) {
                ...
                if (respuesta == 2 && myWorld != cantMundos - 1) {// pasar al siguiente mundo
                    myWorld++;
                    laberinto = mundo.get(myWorld);
                ...
                if (respuesta == -1) {
                    ...
                    mensaje = "No se puede realizar la accion, revisar el saco";
                } else {
                    mensaje = "";
                }
